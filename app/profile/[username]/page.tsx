...
// Define both params and searchParams as Promises to match the expected type
interface PageProps {
...
export default async function ProfilePage({ params, searchParams }: PageProps) {
  // Await the params Promise to get the actual username
  const resolvedParams = await params;
  const username = resolvedParams.username;

  // We don't need to use searchParams in this component, but we'll await it if it exists
  if (searchParams) {
    await searchParams;
  }
